      ...
      <!-- Button trigger modal -->
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <div class="card mb-4">
                    <h5 class="card-header">Form Tambah Pengeluaran</h5>
                    <div class="card-body">
                    <div class="mb-3">
        ...
        <div class="card-body">
          <div class="table-responsive text-nowrap">
            <table class="table table-bordered">
              ...
              <tbody>
                <?php $no=1; foreach($pengeluaran as $a) { ?>
                <tr>
                  <td>
                  ...
                  <td  class="text-center">
                    <a onClick="return confirm('Apakah anda yakin ingin menghapus data ini?')" href="<?= base_url('pengeluaran/hapus/'.$a['id_transaksi'])?>"><i class="bx bx-trash me-1"></i> </a>
                  </td>
                </tr>
                <?php $no++; } ?>
