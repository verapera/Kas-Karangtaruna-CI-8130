...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Mekarwangi</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item <?php if($menu=="pemasukan"){echo 'active';}?>">
              <a href="<?= base_url('pemasukan')?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Pemasukan</div>
              </a>
            </li>
             <li class="menu-item <?php if($menu=="pengeluaran"){echo 'active';}?>">
